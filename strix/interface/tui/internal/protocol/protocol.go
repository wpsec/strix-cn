...
type Snapshot struct {
	...
	ProxyRecentRequestHasMore bool             `json:"proxy_recent_request_has_more"`
	ProxyLatestMethod         string           `json:"proxy_latest_method"`
	ProxyLatestHost           string           `json:"proxy_latest_host"`
	ProxyLatestPath           string           `json:"proxy_latest_path"`
	ProxyLatestStatusCode     *int             `json:"proxy_latest_status_code"`
